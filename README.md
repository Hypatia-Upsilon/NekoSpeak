...
[![Download APK](https://img.shields.io/badge/Download-APK%20(v1.4.1)-blue?style=for-the-badge&logo=android)](https://github.com/siva-sub/NekoSpeak/releases)
...
**v1.4.1 is now available!** (ARMv7 compatibility fix)
...
*   **Universal** (135 MB): Works on all devices.
    *   [Download apk](https://github.com/siva-sub/NekoSpeak/releases/download/v1.4.1/app-universal-release.apk)
*   **arm64-v8a** (88 MB): Optimized for modern devices (Pixel, Samsung S-series).
    *   [Download apk](https://github.com/siva-sub/NekoSpeak/releases/download/v1.4.1/app-arm64-v8a-release.apk)
*   **armeabi-v7a** (82 MB): Optimized for older/low-end devices.
    *   [Download apk](https://github.com/siva-sub/NekoSpeak/releases/download/v1.4.1/app-armeabi-v7a-release.apk)

[**View Full Release Notes**](https://github.com/siva-sub/NekoSpeak/releases/tag/v1.4.1)
